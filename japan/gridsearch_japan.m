...
%alphas=[1e-8,logspace(-7,-5.5,3),logspace(-4.9,-3,8),logspace(-2.8,-2.3,5),logspace(-2.2,-1.6,9),logspace(-1.45,-0.5,6),logspace(-0.2,1,4)];

betas=[logspace(-8,-6,5),logspace(-5.5,-4.5,5),logspace(-4.35,-2.8,12),logspace(-2.6,0,7)];
alphas=[1e-8,logspace(-7,-5.5,3),logspace(-4.9,-3,7),logspace(-2.8,-2.3,5),logspace(-2.2,-1.4,12),logspace(-1.3,-0.7,5),logspace(-0.5,1,5)];
...
colorbar
view(2)
title('Difference for \Delta ABIC < 100')
caxis([0 1])
