...
betas=[1e-8];%,logspace(-6,-4,5),logspace(-3.9,-1.2,24),logspace(-1,1,10)];
alphas=logspace(-1.05,-0.95,4);
betas=[1e-8,logspace(-4.2,-3.2,4)];
...
%%
print(gcf,'figures/suppl_fig_s9_cv_japan', '-dpdf')
