function [u1,u2,u3]=computeDisplacementDippingShearZoneTanhSinh( ...
    x1,x2,x3,q1,q2,q3,L,T,W,theta,phi, ...
    epsv11p,epsv12p,epsv13p,epsv22p,epsv23p,epsv33p,G,nu)
% function COMPUTEDISPLACEMENTDIPPINGSHEARZONETANHSINH computes the
...
%         +(lambda*epsvkk+2*G*epsv22)*L*T/4*(G21((1+x)*L/2,y2(y*T/2,W),y3(y*T/2,W))-G21((1+x)*L/2,y2(y*T/2,0),y3(y*T/2,0))) ...
%                         -2*G*epsv23*L*W/4*(G21((1+x)*L/2,y2(T/2,(1+y)*W/2),y3(T/2,(1+y)*W/2))-G21((1+x)*L/2,y2(-T/2,(1+y)*W/2),y3(-T/2,(1+y)*W/2))) ...
%                         +2*G*epsv23*L*T/4*(G31((1+x)*L/2,y2(y*T/2,W),y3(y*T/2,W))-G31((1+x)*L/2,y2(y*T/2,0),y3(y*T/2,0))) ...
%         -(lambda*epsvkk+2*G*epsv33)*L*W/4*(G31((1+x)*L/2,y2(T/2,(1+y)*W/2),y3(T/2,(1+y)*W/2))-G31((1+x)*L/2,y2(-T/2,(1+y)*W/2),y3(-T/2,(1+y)*W/2))) );
%     
% U2=@(x,y) ...
...
%         +(lambda*epsvkk+2*G*epsv22)*L*T/4*(G22((1+x)*L/2,y2(y*T/2,W),y3(y*T/2,W))-G22((1+x)*L/2,y2(y*T/2,0),y3(y*T/2,0))) ...
%                         -2*G*epsv23*L*W/4*(G22((1+x)*L/2,y2(T/2,(1+y)*W/2),y3(T/2,(1+y)*W/2))-G22((1+x)*L/2,y2(-T/2,(1+y)*W/2),y3(-T/2,(1+y)*W/2))) ...
%                         +2*G*epsv23*L*T/4*(G32((1+x)*L/2,y2(y*T/2,W),y3(y*T/2,W))-G32((1+x)*L/2,y2(y*T/2,0),y3(y*T/2,0))) ...
%         -(lambda*epsvkk+2*G*epsv33)*L*W/4*(G32((1+x)*L/2,y2(T/2,(1+y)*W/2),y3(T/2,(1+y)*W/2))-G32((1+x)*L/2,y2(-T/2,(1+y)*W/2),y3(-T/2,(1+y)*W/2))) );
%     
% U3=@(x,y) ...
...
%         +(lambda*epsvkk+2*G*epsv22)*L*T/4*(G23((1+x)*L/2,y2(y*T/2,W),y3(y*T/2,W))-G23((1+x)*L/2,y2(y*T/2,0),y3(y*T/2,0))) ...
%                         -2*G*epsv23*L*W/4*(G23((1+x)*L/2,y2(T/2,(1+y)*W/2),y3(T/2,(1+y)*W/2))-G23((1+x)*L/2,y2(-T/2,(1+y)*W/2),y3(-T/2,(1+y)*W/2))) ...
%                         +2*G*epsv23*L*T/4*(G33((1+x)*L/2,y2(y*T/2,W),y3(y*T/2,W))-G33((1+x)*L/2,y2(y*T/2,0),y3(y*T/2,0))) ...
%         -(lambda*epsvkk+2*G*epsv33)*L*W/4*(G33((1+x)*L/2,y2(T/2,(1+y)*W/2),y3(T/2,(1+y)*W/2))-G33((1+x)*L/2,y2(-T/2,(1+y)*W/2),y3(-T/2,(1+y)*W/2))) );
