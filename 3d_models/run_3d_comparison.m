...
outfname = 'test_data_3d/coupling_model_smoothonly.dat';
save_jointinv_model_trench0(scenario, coupling, outfname)

outfname = 'test_data_3d/coupling_difference_smoothonly.dat';
...
outfname = 'test_data_3d/stress_smoothonly.dat';
...
outfname = 'test_data_3d/coupling_model_constrainedsmooth.dat';
save_jointinv_model_trench0(scenario, coupling, outfname)

outfname = 'test_data_3d/coupling_difference_constrainedsmooth.dat';
save_jointinv_model_trench0(scenario, coupling - true_coupling, outfname)
...
outfname = 'test_data_3d/stress_constrainedsmooth.dat';
save_jointinv_model_trench0(scenario, -stress_ds, outfname)
...
outfname = 'test_data_3d/coupling_model_constrainedonly.dat';
save_jointinv_model_trench0(scenario, coupling, outfname)

outfname = 'test_data_3d/coupling_difference_constrainedonly.dat';
save_jointinv_model_trench0(scenario, coupling - true_coupling, outfname)
...
outfname = 'test_data_3d/stress_constrainedonly.dat';
save_jointinv_model_trench0(scenario, -stress_ds, outfname)
